...
import autoload "../autoload/tst.vim" as tst9
...
function! TaskStackMappings() " {{{
    ...
    "nmap <buffer> <silent> NP <ScriptCmd>call s:tst9.Project.newFromWord().InsertUnderCurrentProject()<CR>
    nmap <buffer> <silent> NP <ScriptCmd>call s:tst9.ProjectFromWord().InsertUnderCurrentProject()<CR>
